      ...
      <main className="space-y-10">
        ...
        {presets.length > 0 && (
          <section className="text-center">
            <h3 className="text-lg font-semibold text-zinc-800 dark:text-zinc-100 mb-4">{t('presets.quickPresets')}</h3>
            ...
            {isRendering ? (
              <>
                ...
                <span className="relative z-10 flex items-center gap-2">
                  ...
                  {downloadProgress > 0 ? t('common.renderingProgress', { progress: downloadProgress }) : t('common.rendering')}
                </span>
              </>
            ) : (
              <>
